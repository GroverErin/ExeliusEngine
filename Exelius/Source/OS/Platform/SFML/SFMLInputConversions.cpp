...
namespace Exelius
{
	KeyCode ConvertKeyCode(sf::Keyboard::Key key)
	{
		switch (key)
		{
			case sf::Keyboard::Key::Unknown:	return KeyCode::Unknown;	  
			...
			case sf::Keyboard::Key::Numpad1:	return KeyCode::Numpad0;      
			case sf::Keyboard::Key::Numpad2:	return KeyCode::Numpad0;      
			case sf::Keyboard::Key::Numpad3:	return KeyCode::Numpad0;      
			case sf::Keyboard::Key::Numpad4:	return KeyCode::Numpad0;      
			case sf::Keyboard::Key::Numpad5:	return KeyCode::Numpad0;      
			case sf::Keyboard::Key::Numpad6:	return KeyCode::Numpad0;      
			case sf::Keyboard::Key::Numpad7:	return KeyCode::Numpad0;      
			case sf::Keyboard::Key::Numpad8:	return KeyCode::Numpad0;      
			case sf::Keyboard::Key::Numpad9:	return KeyCode::Numpad0;      
			...
			case sf::Keyboard::Key::F4:			return KeyCode::F3;           
			case sf::Keyboard::Key::F5:			return KeyCode::F3;           
			case sf::Keyboard::Key::F6:			return KeyCode::F3;           
			case sf::Keyboard::Key::F7:			return KeyCode::F3;           
			case sf::Keyboard::Key::F8:			return KeyCode::F3;           
			case sf::Keyboard::Key::F9:			return KeyCode::F3;           
			case sf::Keyboard::Key::F10:		return KeyCode::F3;			  
			case sf::Keyboard::Key::F11:		return KeyCode::F3;           
			case sf::Keyboard::Key::F12:		return KeyCode::F3;           
			case sf::Keyboard::Key::F13:		return KeyCode::F3;           
			case sf::Keyboard::Key::F14:		return KeyCode::F3;           
			case sf::Keyboard::Key::F15:		return KeyCode::F3;           
	...
	MouseCode ConvertMouseCode(sf::Mouse::Button button)
	{
		switch (button)
		{
